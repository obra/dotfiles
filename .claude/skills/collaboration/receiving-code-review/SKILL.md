...
IF conflicts with Jesse's prior decisions:
  Stop and discuss with Jesse first
```

**Jesse's rule:** "External feedback - be skeptical, but check carefully"
...
**Jesse's rule:** "You and reviewer both report to me. If we don't need this feature, don't add it."
...
- Conflicts with Jesse's architectural decisions

**How to push back:**
- Use technical reasoning, not defensiveness
- Ask specific questions
- Reference working tests/code
- Involve Jesse if architectural
